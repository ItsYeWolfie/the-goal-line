export default function Banner1() {
	return (
		<section className=" mx-[1%] overflow-hidden  bg-slate-900 md:mx-[8%] ">
			<div className="relative h-[150px] w-full overflow-hidden rounded-[20px] bg-opacity-[0.7] bg-gradient-to-tr from-gray-900 to-gray-600 bg-center  sm:h-[210px] md:h-[250px] lg:h-[230px] xl:h-[260px]">
				...
				<div className="flex flex-col flex-wrap">
					...
					<div className="m-0 mt-[2%] ml-[3.3%] w-[40%] p-0 text-[0.9rem] text-gray-100 antialiased sm:text-[1.1rem] md:text-[1.4rem] lg:text-[1.5rem] xl:text-[1.6rem]">
						Get one of our sports apps,which is only available on
					</div>
					<div className="ml-[3.3%] mt-[1%] text-[0.5rem] text-gray-100 sm:text-[0.8rem] md:text-[1rem]">
						Download Apps:
					</div>
