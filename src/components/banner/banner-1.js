...
class Banner1 extends LitLightElement {
	render() {
		return html`
			<section class="m-[3%]">
				<div
					class="relative h-[19vh] w-full overflow-hidden rounded-[20px] bg-opacity-[0.7] bg-gradient-to-tr from-gray-900 to-gray-600 shadow-lg shadow-slate-500 sm:h-[27vh] md:h-[32vh] xl:h-[35vh]"
