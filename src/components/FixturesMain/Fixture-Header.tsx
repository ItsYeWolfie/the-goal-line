	...
	return (
		<div className="relative h-[125px] w-full border-b-[5px] border-gray-300">
			<div className="flex items-center">
				<p className=" mt-[6%]  ml-[3%] flex w-full  gap-[1%] text-[20px] text-gray-200 sm:mt-[2%] md:mt-[1%] md:ml-[1%]">
					<FaRegFutbol className=" mr-[0.4%] mt-[0.4%]  rounded-full text-[20px] text-yellow-500" />
					Football Matches
				</p>
			</div>
			<div className="absolute bottom-[-5px] flex h-[50px] w-[100%] items-start gap-[6%] md:gap-[6%]">
				<p
					className={`h-full pl-[2.5%] text-center text-[14px] md:text-[17px] ${
				...
				<p
					className={`h-full text-center text-[14px] md:text-[17px] ${
